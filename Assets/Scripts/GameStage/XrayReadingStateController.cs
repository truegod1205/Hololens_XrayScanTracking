...
{
    public class XrayReadingStateController : MonoBehaviour
    {
        [SerializeField]
        private XRayScan.Screen.ReadingMeshCreater meshCreator;
        ...
        {
            this.meshCreator.OnClickStartReading += this.ListenClickStartReading;
        ...
        public void ShutDownStateMachine() 
        {
            ...
            this.meshCreator.SwitchCheckButton(false);
        ...
        private void ListenClickStartReading()
        {
