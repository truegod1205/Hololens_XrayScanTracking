...
{
    public enum ReadingCheckButtonColor
    {
        Red,
        Yellow,
        DeepYellow,
    ...
    public class ReadingScreen : MonoBehaviour
    {
        ...
        [SerializeField]
        private Image CheckButtonBG;

        [SerializeField]
        private Image CheckButtonFront;
        ...
        [SerializeField]
        private Color colorFrontRed;

        [SerializeField]
        private Color colorBGYellow;

        [SerializeField]
        private Color colorFrontYellow;
        ...
        public void ReFrameScreen()
        {
            ...
            this.RestartButton.transform.localPosition = new Vector3(0.5f * width + 0.15f, 0, 0);
        }
        ...
        {
            this.CheckButton.SetActive(enable);
        }

        public void SetCheckButtonColor(ReadingCheckButtonColor colorType)
        {
            if (colorType == ReadingCheckButtonColor.Yellow)
            {
                this.CheckButtonBG.color = this.colorBGYellow;
                this.CheckButtonFront.color = this.colorFrontYellow;
            }
            else if (colorType == ReadingCheckButtonColor.Red)
            {
                this.CheckButtonBG.color = this.colorFrontRed;
                this.CheckButtonFront.color = this.colorFrontRed;
            }
            else if (colorType == ReadingCheckButtonColor.DeepYellow)
            {
                this.CheckButtonBG.color = this.colorFrontYellow;
                this.CheckButtonFront.color = this.colorFrontYellow;
            }
        }
