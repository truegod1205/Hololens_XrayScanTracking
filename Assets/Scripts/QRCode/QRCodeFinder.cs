...
{
    public class QRCodeFinder : QRCodeListener
    {
        ...
        [SerializeField]
        private XRayScan.Screen.FindScreen findSrceen;
        ...
        public override void HandleQRCodeAdded(Microsoft.MixedReality.QR.QRCode qrCode)
        {
            ...
            if ((qrCodePrefab != null))
            {
                ...
                if (found)
                {
                    var obj = Instantiate(qrCodePrefab, QRPose.position, QRPose.rotation);
                    this.findSrceen.AddGridCorner(obj);
                }
            }
        }
